...
python /home/mfrance/software/PartitionFinder/partitionfinder-2.1.1/PartitionFinderProtein.py /local/scratch/mfrance/EZAK/03_phylogeny/ --raxml --rcluster-max 100 -p 16 -q
